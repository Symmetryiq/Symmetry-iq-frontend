  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.contentWrapper}>
        <Typography size={18} color="onMuted">
          {formattedDate}
        </Typography>
        ...
        <View style={styles.progressBarWrapper}>
          <View style={{ gap: verticalScale(4) }}>
            <View style={styles.progressBarContainer}>
              <Typography size={14} color="onTertiary" font="semiBold">
                Overall Score
              </Typography>
              <Typography size={16} color="onPrimary" font="semiBold">
                {overallScore}%
              </Typography>
            </View>
  ...
  return (
    <View style={styles.progressBar}>
      <View
        style={[
          styles.progress,
          { width: `${progress}%`, backgroundColor: getColorByScore(progress) },
        ]}
      />
    </View>
  );
