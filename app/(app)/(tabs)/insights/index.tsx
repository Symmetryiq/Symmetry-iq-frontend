...
const Insights = () => {
  ...
  const { bestFeatures, improvements, overallScore } = React.useMemo(() => {
    if (!currentScan)
      return { bestFeatures: [], improvements: [], overallScore: 0 };
      ...
      >
        <Section>
          ...
          <View
            style={[
              styles.card,
              { borderColor: getColorByScore(overallScore) },
            ]}
          >
            <CircularProgress
            ...
            <View style={styles.cardContentWrapper}>
              ...
              <Typography color="onTertiary" style={{ textAlign: "center" }}>
                {overallScore > 80
                  ? "Your symmetry is excellent! Keep up the good work."
                  : overallScore > 50
                    ? "Good foundation. Specific exercises can help balance features."
              ...
              {bestFeatures.map((item) => (
                ...
                >
                  <CircularProgress
                    ...
                    strokeWidth={16}
                    outerCircleColor={Colors.border}
                    progressCircleColor={getColorByScore(
                      item.value,
                      item.key === "facialPuffiness",
                    )}
                  />
