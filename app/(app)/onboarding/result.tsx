...
import { InfoIcon, SparkleIcon, XIcon } from 'phosphor-react-native';
...
/** IDs visible in the free demo — everything else is blurred. */
const FREE_FEATURE_IDS: ReadonlySet<FeatureID> = new Set([
  'overall_symmetry',
  'eye_alignment',
  'nose_centering',
]);
  ...
  return (
    <View style={styles.card}>
      ...
      {locked && (
        ...
        >
          <LockIcon color={COLOR.onSecondary} size={20} />
        </BlurView>
      )}
    </View>
  );
    ...
    return (
      <ScreenView style={styles.emptyContainer}>
        ...
        <ThemedText color="onSecondary" style={styles.emptyText}>
          Take a photo first to see your results.
        </ThemedText>
        <Button
          title="Go Back"
          variant="primary"
          onPress={() => navigateTo('/onboarding/demo')}
        />
      </ScreenView>
    );
  }

  const { scores, imageUri } = currentScan;
  ...
  return (
    <ScreenView style={styles.container}>
      ...
      <Button
        ...
        iconPosition="right"
        onPress={() => {
          navigateTo('/onboarding/purchase');
        }}
      />
